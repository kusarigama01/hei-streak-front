	...
	return (
		<div className="dashboard-layout">
			...
			<main className="dashboard-viewport">
				...
				{section === SECTIONS.EXAMS && !isCreatingExam && !editingExam && !viewingQuestionsFor && !viewingResultsFor && (
					<>
						{exams.length === 0 ? (
							<div className="empty-state">
								<img src={logo} alt="" className="empty-state-logo" />
				...
				{section === SECTIONS.EXAMS && editingExam && (
					<ExamForm
						...
						onCreate={(updatedData) => {
							setExams(
								exams.map((ex) =>
									ex.id === editingExam.id ? { ...ex, ...updatedData } : ex
								)
							);
							setEditingExam(null);
						}}
